...
var Request = __nccwpck_require__(6634);
...
var AuthenticationRequest = __nccwpck_require__(1790);
var HttpManager = __nccwpck_require__(3448);
...
var SpotifyWebApi = __nccwpck_require__(4938);
var ServerMethods = __nccwpck_require__(5146);
...
var AuthenticationRequest = __nccwpck_require__(1790),
  WebApiRequest = __nccwpck_require__(5846),
  HttpManager = __nccwpck_require__(3448);
...
var mime = __nccwpck_require__(8912);
...
let Mime = __nccwpck_require__(234);
module.exports = new Mime(__nccwpck_require__(9977), __nccwpck_require__(9321));
...
;// CONCATENATED MODULE: ./node_modules/spotify-to-jekyll/src/update-main.js


async function updateMain(data) {
  try {
    const newContents = await buildNewMain(data);
    const promise = (0,promises_namespaceObject.writeFile)("_data/playlists.yml", newContents);
...
async function buildNewMain(data) {
  try {
    const promise = (0,promises_namespaceObject.readFile)("_data/playlists.yml", "utf-8");
...
;// CONCATENATED MODULE: ./node_modules/spotify-to-jekyll/src/format-tracks.js
